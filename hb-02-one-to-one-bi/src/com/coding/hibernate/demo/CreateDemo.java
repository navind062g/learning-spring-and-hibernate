...
public class CreateDemo {
	...
	public static void main(String[] args) {
		...
		try {
			sessionFactory = new Configuration().configure().addAnnotatedClass(InstructorDetail.class)
			...
			InstructorDetail tempInsDetail = new InstructorDetail("www.udemy.com", "React JS");
